...
class TestDataPipeline(unittest.TestCase):
    def setUp(self):
        ...
        self.dummy_sample = Sample(
            image_path="dummy.jpg", bboxes=[[10, 10, 40, 40]], categories=[1], waypoints=[[0.0, 0.0]] * 10, command=0
        )
    ...
    def test_mosaic(self):
        ...
        with patch("random.randint", return_value=0), patch("random.uniform", return_value=112):
