...
class MockCallback(Callback):
    ...
    def on_train_start(self, trainer):
        self.triggers.append("on_train_start")

    def on_predict_start(self, predictor):
        self.triggers.append("on_predict_start")

    def on_predict_end(self, predictor):
        self.triggers.append("on_predict_end")

    def on_export_start(self, exporter):
        self.triggers.append("on_export_start")

    def on_export_end(self, exporter):
        self.triggers.append("on_export_end")

    def on_val_start(self, validator):
        self.triggers.append("on_val_start")

    def on_val_end(self, validator):
        self.triggers.append("on_val_end")
