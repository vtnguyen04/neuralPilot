...
class Validator(BaseValidator):
    ...
    def init_metrics(self):
        ...
        self.traj_metric = TrajectoryMetric(tau_start=self.cfg.loss.fdat_tau_start, tau_end=self.cfg.loss.fdat_tau_end)
        self.total_loss = 0.0
                ...
                for j in range(img.size(0)):
                    ...
                    if k_boxes.numel() > 0:
                        ...
                        formatted_preds.append(
                            {"boxes": xyxy[keep], "scores": k_scores[keep], "labels": k_labels[keep]}
                        )
                    else:
                        formatted_preds.append(
                            {
